...
function Home() {
  ...
  return (
    <div>
      ...
      <SectionWithImage image={<img src={require('../../atoms/images/Group 4565.png')} alt='not found' style={{ marginTop: '-80px' }} />}>
        <SectionData
      ...
      <SectionWithImage image={<img src={require('../../atoms/images/g10.png')} alt='not found' />} rtl={true}>
        <SectionData
      ...
      <SectionWithImage image={<img src={require('../../atoms/images/g10.png')} alt='not found' />} backgroundColor='#E6F5EA'>
        <SectionData
